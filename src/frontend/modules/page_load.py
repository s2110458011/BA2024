...
class Load(ctk.CTkFrame):
    ...
    def survey_preview_frame(self) -> ctk.CTkFrame:
        ...
        scroll_Y = tk.Scrollbar(self.data_table, orient='vertical', command=self.data_table.yview)
        scroll_X = tk.Scrollbar(self.data_table, orient='horizontal', command=self.data_table.xview)
